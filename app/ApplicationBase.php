    ...
    protected function registerProviders()
    {
        ...
        $this->extend(
            ...
            function ($translator, $app) {
                ...
                $translator->addResource('yaml', __DIR__ . '/../locales/eventtype/de.yml', 'de', 'eventtype');
                ...
                $translator->addResource('yaml', __DIR__ . '/../locales/facets/de.yml', 'de', 'facets');
                ...
                $translator->addResource('yaml', __DIR__ . '/../locales/region/de.yml', 'de', 'region');
                ...
                $translator->addResource('yaml', __DIR__ . '/../locales/theme/de.yml', 'de', 'theme');
                ...
                $translator->addResource('yaml', __DIR__ . '/../locales/when/de.yml', 'de', 'when');
        ...
        $this->register(
            ...
            [
                ...
                'search_api.client_id' => $this['config']['search_api']['live']['client_id'],
                'search_api_test.base_url' => $this['config']['search_api']['test']['base_url'],
                'search_api_test.api_key' => $this['config']['search_api']['test']['api_key'],
                'search_api_test.client_id' => $this['config']['search_api']['test']['client_id'],
