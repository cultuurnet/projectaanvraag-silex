(function($) {
  // make sure this plugin does not get loaded twice, it can result in an endless recursive loop when $.fn.val is used
  if (typeof $.support.placeholder !== "undefined") return;
