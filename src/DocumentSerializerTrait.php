...
/**
 * Trait that enables json / array serialization for documents.
 * @package CultuurNet\ProjectAanvraag
 */
trait DocumentSerializerTrait
{
    ...
    public function toStdClass()
    {
        ...
        foreach ($this->findGetters() as $getter) {
            ...
            if (! in_array($prop, $this->ignoreFields)) {
                $value = $this->$getter();
